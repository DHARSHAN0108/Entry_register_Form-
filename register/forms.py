...
class AppointmentDetailsForm(forms.ModelForm):
    ...
    def clean_appointment_date(self):
        ...
        if not appt_date or appt_date < date.today():
            raise forms.ValidationError("Appointment date must be a future date.")
        return appt_date
...
class RescheduleForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'designated_attendee': forms.Select(attrs={
                'class': 'form-control'
            }),
        }
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['reason'].required = False  # Make reason optional for reschedule
    ...
    def clean_appointment_time(self):
        ...
        if not (start <= appt_time <= end):
            raise forms.ValidationError("Appointment time must be between 09:00 and 22:00.")
        return appt_time
